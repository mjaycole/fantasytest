...
public class DialogueEditor : EditorWindow
{
    ...
    private void OnEnable()
    {
        ...
        //Set background styles for the nodes
        nodeStyle = new GUIStyle();
        nodeStyle.normal.background = EditorGUIUtility.Load("node0") as Texture2D;
        nodeStyle.normal.textColor = Color.red;
        nodeStyle.padding = new RectOffset(20, 20, 20, 20);
        nodeStyle.border = new RectOffset(12, 12, 12, 12);

        //Set background styles for the player nodes
        playerNodeStyle = new GUIStyle();
        playerNodeStyle.normal.background = EditorGUIUtility.Load("node1") as Texture2D;
        playerNodeStyle.normal.textColor = Color.red;
    ...
    private void OnSelectionChanged()
    {
        ...
        else //Add else-if statement so it doesn't just make stuff disappear
        {
